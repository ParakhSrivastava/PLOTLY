...
@app.callback(Output('hover-data', 'children'),
              [Input('wheels-plot', 'hoverData')])   # "hoverData" is never defined in dcc.Graph -> It is actually a part of Graph which is not needed to get defined!
